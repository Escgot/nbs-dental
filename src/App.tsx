          ...
          <div className="footer-grid">
            ...
            <div className="footer-col-3">
              ...
              <div className="social-links flex gap-4" style={{ marginTop: '1.5rem' }}>
                <a href="https://www.facebook.com/profile.php?id=61561642716789" target="_blank" rel="noreferrer" className="hover:text-primary transition-colors" style={{ color: '#bbc0bb' }}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
                </a>
                <a href="https://www.instagram.com/dr_nawres_bensalah/" target="_blank" rel="noreferrer" className="hover:text-primary transition-colors" style={{ color: '#bbc0bb' }}>
